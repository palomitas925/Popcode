...
<header>
 ...
 <div class="header-buttons">
     <button class="logout-btn3" onclick="location.href='MainOp.php'">🏠︎</button>
    <button class="logout-btn2" onclick="location.href='escaneo_productoOp.php'">Regresar</button>
