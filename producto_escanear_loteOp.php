...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if ($producto !== '' && $lote !== '') {
    ...
    header("Location: escaneo_productoOp.php");
    exit;
  } else {
...
<body>
    ...
    <form method="POST">
      <div class="form-card">
        ...
        <div class="button-group">
          <button class="cancel-btn" type="button" onclick="window.location.href='MainOp.php'">Cancelar</button>
  ...
  <div class="modal" id="modal">
    <div class="modal-content">
      ...
      <label>Línea:</label>
      <select id="modal-linea"><option value="1">Línea 1</option><option value="2">Línea 2</option><option value="3">Línea 3</option></select>
