  ...
  <main>
    <form class="form-card" method="POST" enctype="multipart/form-data">
      ...
      <div class="button-group">
        <button type="button" class="btn-regresar" onclick="window.location.href='escaneo.php'">Regresar</button>
        <button type="submit" class="btn-registrar">Registrar</button>
        <button type="button" class="btn-reportes" onclick="window.location.href='reportes.php'">Reportes</button>
      </div>
