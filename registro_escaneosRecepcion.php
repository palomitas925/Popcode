...
<header>
 ...
 <div class="header-buttons">
     <button class="logout-btn3" onclick="location.href='MainSuperRecepcion.php'">🏠︎</button>
    <button class="logout-btn2" onclick="location.href='escaneo_productoRecepcion.php'">Regresar</button>
