  ...
  <div class="contenedor">
    <div class="panel-izquierdo">
      ...
      <form method="POST" autocomplete="off">
        ...
        <div class="botones">
          <button type="button" onclick="location.href='producto_escanear_lote_SuperCal.php'">Regresar</button>
          <button type="button" onclick="location.href='registro_escaneos_SuperCal.php'">Registros</button>
        </div>
      </form>
    </div>
