...
<header>
 ...
 <div class="header-buttons">
     <button class="logout-btn3" onclick="location.href='MainSuperTI.php'">🏠︎</button>
    <button class="logout-btn2" onclick="location.href='escaneo_producto_SuperTI.php'">Regresar</button>
