...
<body>
  ...
  <header>
    ...
    <h1>¡Bienvenido!</h1>
    <a href="MainSuperTI.php" class="logout-btnn">Regresar</a>
  ...
  <main>
    ...
    <div class="button-grid">
      <a href="producto_escanear_lote_SuperTI.php" class="action-btn">
        <span>𝄃𝄂𝄀𝄁</span>
        Escaneo
      </a>

      <a href="añadir_SuperTI.php" class="action-btn">
        <span>📝</span>
        Añadir
      </a>
    </div>
